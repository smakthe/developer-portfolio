...
const HelpOutput = () => (
  <div className="mt-2 mb-6">
    ...
    <ul className="space-y-1 opacity-90 pl-2">
      <li>
        <span className="font-bold text-green-300 w-28 inline-block">
          whoami
        </span>{" "}
      ...
      <li>
        ...
        - List professional experience & tech stack
      </li>
      <li>
        <span className="font-bold text-green-300 w-28 inline-block">
          projects
        </span>{" "}
        - View featured portfolio projects
      </li>
      <li>
        <span className="font-bold text-green-300 w-28 inline-block">
          resume
      ...
      <li>
        <span className="font-bold text-green-300 w-28 inline-block">help</span>{" "}
        - Show this message
      </li>
    </ul>
  </div>
...
const WhoamiOutput = () => (
  <div className="mt-2 mb-6 max-w-4xl border-l-2 border-green-500/50 pl-4">
    ...
    <p className="opacity-90 mb-4 leading-relaxed">
      ...
      <br />
      With over 7.5 years of professional experience, I specialize in building
      robust, fault-tolerant SaaS applications ensuring high throughput and low
      latency. I bridge the gap between elegant system architecture and
...
const ExperienceOutput = () => (
  <div className="mt-2 mb-6">
    <p className="mb-6 opacity-90 leading-relaxed max-w-4xl border-l-2 border-green-500/50 pl-4">
      ...
      robust, scalable and fault-tollerant SaaS based applications with high
      throughput and low latency. My primary tech stack has been Ruby on Rails
      but I also have experience with LAMP and MERN stack.
    </p>
      ...
      <div key={i} className="mb-4 pl-4 border-l-2 border-green-500/50">
        <div className="flex flex-wrap items-center gap-3 mb-1">
          ...
          <a
            ...
            className="hover:bg-green-500 hover:text-black border border-green-500/50 px-2 text-xs flex items-center gap-1 py-0.5 transition-colors"
          >
...
const ResumeOutput = () => (
  <div className="mt-2 mb-6 border border-green-500/50 p-4 inline-block bg-green-500/5">
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="hover:bg-green-500 hover:text-black px-6 py-2 border border-green-500 inline-flex items-center gap-2 transition-colors"
    >
...
export default function InteractiveTerminal() {
  ...
  const executeCommand = (cmdStr: string) => {
    ...
    switch (cmd) {
      ...
      default:
        output = (
          <div className="mt-2 mb-6 text-green-500 opacity-80">
    ...
    setHistory((prev) => [
      ...prev,
      { id: Date.now(), command: cmdStr, output },
    ]);
    setInput("");
  };
