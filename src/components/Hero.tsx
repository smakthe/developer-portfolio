          ...
          >
            ...
            {skillsList.map((skill, i) => (
              ...
              >
                ...
                <div>
                  <span className="block text-base sm:text-lg font-bold text-slate-900 mb-1">{skill.label}</span>
                  <span className="text-xs sm:text-sm text-slate-500 font-medium">{skill.desc}</span>
                </div>
              </motion.div>
            ))}
          </motion.div>
